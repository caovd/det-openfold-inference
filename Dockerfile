...
# NEW - to fix error (https://github.com/NVIDIA/nvidia-docker/issues/1009)
...
RUN apt-get update && apt-get install -y wget libxml2 cuda-minimal-build-11-3-1 libcusparse-dev-11-3 libcublas-dev-11-3 libcusolver-dev-11-3 git
RUN wget -P /tmp \
